...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Bangu.jpeg" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Bangu.jpeg" alt="Thumbnail 1">
          <img src="../images/Bangu.jpeg" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Bangu I 23/24 Torcedor Kappa Masculina</h1>
        ...
        <div class="product-price center">
          <span>R$ 149,90</span>
          <span class="discount center">R$ 299,90</span>
        </div>
        ...
        <div class="product-description">
          <p>Camisa Kappa Bangu I 2024 - Masculina <br>
            Tecnologia <br>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          <a href="camisa_campogrande.php"><img src="../images/Campo Grande.jpeg" alt="" width="150px" /></a>
          <p class="product-name">Camisa Campo Grande <br> I 23/24 Torcedor WA Sport Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
        <div class="produto-relacionado">
          <a href="camisa_madureira.php"><img src="../images/Madureira.jpeg" alt="" width="150px" /></a>
          <p class="product-name">Camisa Madureira <br> I 23/24 Torcedor Icone Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
        <div class="produto-relacionado">
          <a href="camisa_novaiguaçu.php"><img src="../images/Nova Iguaçu.jpeg" alt="" width="150px" /></a>
          <p class="product-name">Camisa Nova Iguaçu <br> I 23/24 Torcedor Icone Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
      </div>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '1'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      // Criar um objeto produto com os detalhes necessários
      const product = {
        id: productId = 1, // Usar o productId recebido como parâmetro
        name: 'Camisa Bangu I 23/24 Torcedor Kappa Masculina', // Ajustar conforme necessário
        price: 149.90,
        image: '../images/Bangu.jpeg'
      };
