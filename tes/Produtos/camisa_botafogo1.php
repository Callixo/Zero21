...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Botafogo-1.png" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Botafogo-1.png" alt="Thumbnail 1">
          <img src="../images/Botafogo-1.png" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Botafogo I 23/24 Torcedor Reebok Masculina</h1>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          <a href="camisa_botafogo2.php"><img src="../images/Botafogo-2.png" alt="" width="150px" /></a>
          <p class="product-name">Camisa Botafogo <br> II 23/24 Torcedor Reebok Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
        <div class="produto-relacionado">
          <a href="camisa_vasco1.php"><img src="../images/Vasco-1.png" alt="" width="150px" /></a>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '3'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId = 3,
        name: 'Camisa Botafogo I 23/24 Torcedor Rebok Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Botafogo-1.png'
      };
