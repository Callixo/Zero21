...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Campo Grande.jpeg" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Campo Grande.jpeg" alt="Thumbnail 1">
          <img src="../images/Campo Grande.jpeg" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Campo Grande I 23/24 Torcedor WA Sport Masculina</h1>
        ...
        <div class="product-description">
          <p>Camisa Campo Grande I 23/24 - Masculina <br>
            Tecnologia <br>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          <a href="camisa_bangu.php"><img src="../images/Bangu.jpeg" alt="" width="150px" /></a>
          <p class="product-name">Camisa Bangu <br> I 23/24 Torcedor Kappa Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '2'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId = 2,
        name: 'Camisa Campo Grande I 23/24 Torcedor WA Sport Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Campo Grande.jpeg'
      };
