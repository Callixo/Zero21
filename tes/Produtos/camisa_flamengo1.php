...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Flamengo-1.png" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Flamengo-1.png" alt="Thumbnail 1">
          <img src="../images/Flamengo-1.png" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Flamengo I 23/24 Torcedor Adidas Masculina</h1>
        <div class="product-rating center">
          <span>⭐⭐⭐⭐☆</span>
          <span>(7.259 avaliações)</span>
        </div>
        ...
        <div class="product-description">
          <p>Camisa Adidas Flamengo I 23/24 - Masculina <br>
            Tecnologia <br>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          <a href="camisa_botafogo1.php"><img src="../images/Botafogo-1.png" alt="" width="150px" /></a>
          <p class="product-name">Camisa Botafogo <br> I 23/24 Torcedor Reebok Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '5'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Flamengo I 23/24 Torcedor Adidas Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Flamengo-1.png'
      };
