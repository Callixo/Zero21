...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Flamengo-2.png" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Flamengo-2.png" alt="Thumbnail 1">
          <img src="../images/Flamengo-2.png" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Flamengo II 23/24 Torcedor Adidas Masculina</h1>
        <div class="product-rating center">
          <span>⭐⭐⭐⭐☆</span>
          <span>(5.259 avaliações)</span>
        </div>
        ...
        <div class="product-description">
          <p>Camisa Adidas Flamengo II 23/24 Torcedor Adidas Masculina <br>
            Tecnologia <br>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          <a href="camisa_botafogo1.php"><img src="../images/Botafogo-2.png" alt="" width="150px" /></a>
          <p class="product-name">Camisa Botafogo <br> II 23/24 Torcedor Reebok Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
        <div class="produto-relacionado">
          <a href="camisa_vasco1.php"><img src="../images/Vasco.png" alt="" width="150px" /></a>
          <p class="product-name">Camisa Vasco <br> II 23/24 Torcedor Kappa Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
        <div class="produto-relacionado">
          <a href="camisa_fluminense1.php"><img src="../images/Fluminense.png" alt="" width="150px" /></a>
          <p class="product-name">Camisa Fluminense <br> I 23/24 Torcedor Umbro Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
          <p class="product-price"><span>R$ </span>149,90</p>
        </div>
      </div>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '6'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Flamengo II 23/24 Torcedor Adidas Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Flamengo-2.png'
      };
