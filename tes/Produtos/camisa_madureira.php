...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Madureira.jpeg" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Madureira.jpeg" alt="Thumbnail 1">
          <img src="../images/Madureira.jpeg" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Madureira I 23/24 Torcedor Icone Masculina</h1>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '9'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Madureira I 23/24 Torcedor Icone Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Madureira.jpeg'
      };
