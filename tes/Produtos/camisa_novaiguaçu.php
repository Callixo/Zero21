...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Nova Iguaçu.jpeg" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Nova Iguaçu.jpeg" alt="Thumbnail 1">
          <img src="../images/Nova Iguaçu.jpeg" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Nova Iguaçu I 23/24 Torcedor Icone Masculina</h1>
        ...
        <div class="product-description">
          <p>Camisa Nova Iguaçu I 23/24 - Masculina <br>
            Tecnologia <br>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '10'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Nova Iguaçu I 23/24 Torcedor Kappa Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Nova Iguaçu.jpeg'
      };
