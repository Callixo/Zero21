...
// Conectar ao banco de dados (substitua essas configurações com as suas)
  ...
  <div class="navbar">
    ...
    <div class="produto">
        <div class="produto-img">
            <img src="<?php echo $produto['imagem']; ?>" alt="Produto imagem principal" id="product-image">
        </div>
        <div class="product-details">
            ...
            <button class="add-to-cart" onclick="addToCart(<?php echo $produto['id']; ?>)">Adicionar ao Carrinho</button>
    ...
    <script>
        ...
        function addToCart(productId) {
            ...
            const product = {
                id: productId,
                name: 'Camisa Bangu I 23/24 Torcedor Kappa Masculina', // Ajuste conforme necessário
                price: 149.90,
