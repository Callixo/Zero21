...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Vasco-1.png" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Vasco-1.png" alt="Thumbnail 1">
          <img src="../images/Vasco-1.png" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Vasco I 23/24 Torcedor Kappa Masculina</h1>
        <div class="product-rating center">
          <span>⭐⭐⭐⭐☆</span>
          <span>(3.987 avaliações)</span>
        </div>
        ...
        <div class="product-description">
          <p>Camisa Vasco I 23/24 Torcedor Keppa Masculina <br>
            Tecnologia <br>
    ...
    <div class="related-products">
      ...
      <div class="produtos-relacionados">
        <div class="produto-relacionado">
          ...
          <p class="product-name">Camisa Bangu <br> I 23/24 Torcedor Icone Masculina</p>
          <p class="rate">&#9733;&#9733;&#9733;&#9733;&#9734;</p>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '11'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Vasco I 23/24 Torcedor Kappa Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Vasco.png'
      };
