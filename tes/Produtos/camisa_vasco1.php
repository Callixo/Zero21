...
<body>
  ...
  <div class="container">
    <div class="produto">
      <div class="produto-img">
        <div id="box">
          <img src="../images/Vasco.png" alt="Produto imagem principal" id="product-image">
          <div id="lens"></div>
        </div>
        <div class="thumbnail-images">
          <img src="../images/Vasco.png" alt="Thumbnail 1">
          <img src="../images/Vasco.png" alt="Thumbnail 2">
          <!-- Mais thumbnails -->
        </div>
      </div>
      <div class="product-details">
        <h1>Camisa Vasco II 23/24 Torcedor Keppa Masculina</h1>
        <div class="product-rating center">
          <span>⭐⭐⭐⭐☆</span>
          <span>(4.879 avaliações)</span>
        </div>
        ...
        <div class="product-description">
          <p>Camisa Vasco II 23/24 Torcedor Kappa Masculina <br>
            Tecnologia <br>
      ...
      <?php if (isset($_SESSION['nome_usuario'])) : ?>
        <div class="avaliacao1">
          <form id="review-form" class="review-form">
            <input type="hidden" name="produto_id" value="<?php echo $produto_id = '12'; ?>">
  ...
  <script>
    ...
    function addToCart(productId) {
      ...
      const product = {
        id: productId,
        name: 'Camisa Vasco II 23/24 Torcedor Kappa Masculina', // Ajuste conforme necessário
        price: 149.90,
        image: '../images/Vasco-1.png'
      };
